...
public final class ElasticsearchRecordSet
        implements RecordSet
{
            ...
            List<ElasticsearchColumnHandle> columnHandles)
    {
        ...
        for (ElasticsearchColumnHandle handle : columnHandles) {
    ...
    {
        return new ElasticsearchRecordCursor(client, config, split, columnHandles);
    }
}
